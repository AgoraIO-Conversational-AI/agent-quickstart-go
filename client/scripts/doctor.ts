...
if (!backendUrl?.trim()) {
  fail(
    'Missing AGENT_BACKEND_URL. The web app proxies /api/* requests to the Go backend and cannot serve them in-process.',
  )
}
...
console.log(`Doctor checks passed for Go-backed web proxy mode (${backendUrl})`)
