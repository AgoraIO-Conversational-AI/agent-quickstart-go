import { createAgoraClient, isAgentAlreadyStoppingOrStopped, proxyToLocalBackend } from '@/lib/server/agora'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const proxiedResponse = await proxyToLocalBackend('v2/stopAgent', {
      method: 'POST',
