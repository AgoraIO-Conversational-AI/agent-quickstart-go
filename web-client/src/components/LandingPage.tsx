  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 60% 40% at 50% 60%, hsl(194 100% 50% / 0.04) 0%, transparent 72%)',
        }}
      />
          ...
          {!sessionData ? (
            <>
              <p className="animate-fade-up animate-fade-up-d2 max-w-lg text-sm leading-relaxed text-muted-foreground sm:text-base">
                This Go quickstart streams real-time speech and a live transcript from the ConvoAI engine—sub-second
                latency, production-style pipeline, and a single backend you can run, adapt, and deploy. No extra wiring
                to feel the product.
              </p>
